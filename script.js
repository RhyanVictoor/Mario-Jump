...
const start = () => {
    ...
    moeda.src = "./imagens/moeda.gif";
    dino.src = "./imagens/dino.gif";
    monstro.src = "./imagens/monstro.gif";
    ...
    function checkCollision() {
        ...
        if (
            marioRect.right > moedaRect.left &&
        ...
        if (
            Math.abs(marioRect.right - monstroRect.left) < proximity &&
            marioBottom <= groundLevel
        ) {
            gameOver();
        }
    }
